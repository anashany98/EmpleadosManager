import { Baby, Calendar as CalendarIcon, Clock, FileText, Heart, MoreHorizontal, Plane, Stethoscope } from 'lucide-react';
...
export const ABSENCE_TYPES: Record<string, AbsenceTypeConfig> = {
    ...
    LACTATION: { label: 'Lactancia', color: 'bg-pink-500', text: 'text-pink-700', bgSoft: 'bg-pink-50', border: 'border-pink-200', icon: Baby },
};
